...
@section('content')
    ...
    <section class="font-sans min-h-screen bg-cover bg-center"
        style="background-image: url({{ asset('assets/pondok.png') }})">
        ...
        <div class="absolute inset-0 bg-cover bg-center"
         style="background-image: url({{ asset('assets/BG-PD.jpg') }});">
            ...
            {{-- <div class="relative w-full flex justify-center items-center mb-12">
                <div
                    class="text-6xl md:text-8xl bg-gradient-to-b from-green via-green/90 to-transparent bg-clip-text text-transparent drop-shadow-lg z-10">
                    Selamat Datang di Simqua
                </div>
            </div> --}}
