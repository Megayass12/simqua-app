    ...
    <section class="font-sans h-screen bg-cover bg-center min-h-screen flex items-center justify-center"
        ...
        <header class="absolute top-0 left-0 w-full z-50 px-20 py-6">
            ...
            <div class="flex items-center text-white text-xl font-semibold">
                <img src="{{ asset('assets/ppmq.png') }}" alt="Logo" class="h-20">
                <span class="ml-4 text-white font">PPMQ GUMUK KEMBAR</span>
            </div>
        </header>
        ...
        <!-- Form content -->
        <div class="bg-white/70 backdrop-blur-md rounded-3xl p-10 w-[600px] relative shadow-xl bg-fit bg-center"
            ...
            <div class="absolute top-4 right-4 text-sm text-gray-600 text-right">
                ...
                <a href="login"
                    class="inline-flex bg-[#94C460] items-center gap-2 border border-brown-700 text-black px-4 py-1 rounded-full font-semibold hover:bg-brown-100 transition text-sm mr-4 hover:bg-green-700 hover:text-white">
                    Masuk
            ...
            <!-- Judul -->
            <h2 class="text-2xl font-bold text-black mb-6 text-center">Daftar</h2>
        ...
        <input type="password" name="password_confirmation" placeholder="Konfirmasi password"
            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring focus:ring-green-500">
                ...
                <div class="flex m-auto w-1/3">
                    <button type="submit"
                        class="w-full bg-green-500 text-white font-semibold py-2.5 rounded-lg hover:bg-green-800 transition text-sm">
                        Daftar
                    </button>
                </div>
            </form>
