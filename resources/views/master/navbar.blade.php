...
<div class="flex items-center gap-10">
    ...
    @elseif(isset($isCalonSantri) && $isCalonSantri)
        ...
        @if(Route::has('V_DaftarUlang'))
            <a href="{{ route('V_DaftarUlang') }}" class="text-emerald-900 font-bold hover:bg-white/10 hover:rounded-lg px-1 hover:border-t hover:border-white">
                Daftar Ulang
            </a>
        @endif
    @endif
